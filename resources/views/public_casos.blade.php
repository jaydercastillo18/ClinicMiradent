...
@section('title', 'Antes y Después | Miradent')
...
<section class="casos-grid-container">
    <div class="container-premium">
        @if($casosExito->isNotEmpty())
        <div class="casos-grid">
            @foreach($casosExito as $caso)
            <div class="case-card fade-up" {!! 'style="animation-delay: ' . ($loop->index * 0.1) . 's;"' !!}>
                <div class="compare-container" data-compare>
                    <!-- Imagen de fondo (DESPUÉS) -->
                    <img src="{{ $caso->after_image }}" alt="Después: {{ $caso->title }}" loading="lazy">

                    <!-- Imagen recortada superpuesta (ANTES) -->
                    <div class="compare-before-wrap">
                        <img src="{{ $caso->before_image }}" alt="Antes: {{ $caso->title }}" loading="lazy">
                    </div>
