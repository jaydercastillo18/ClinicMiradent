...
<div class="container-fluid p-0">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4 pb-2 border-bottom">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size: 0.95rem;">Modifica el expediente clínico de <strong>{{ $paciente->nombre }} {{ $paciente->apellido }}</strong>.</p>
        </div>
        <div>
            @if(request()->ajax())
            ...
            @else
            <a href="{{ route('pacientes.index') }}" class="btn btn-light border d-flex align-items-center gap-2" style="font-weight: 500; padding: 10px 18px; border-radius: 10px;">
    ...
    <form action="{{ route('pacientes.update', $paciente->id) }}" method="POST" data-axios-submit data-axios-no-reload="true" data-axios-close-modal="true" id="form-editpaciente">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $paciente->nombre) }}" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                @error('nombre')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="apellido" id="apellido" class="form-control @error('apellido') is-invalid @enderror" value="{{ old('apellido', $paciente->apellido) }}" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                @error('apellido')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="dni" id="dni" class="form-control @error('dni') is-invalid @enderror" value="{{ old('dni', $paciente->dni) }}" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                @error('dni')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="telefono" id="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono', $paciente->telefono) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                @error('telefono')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $paciente->email) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('fecha_nacimiento', $paciente->fecha_nacimiento) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select name="tipo_sangre" id="tipo_sangre" class="form-select @error('tipo_sangre') is-invalid @enderror" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                    ...
                                    @foreach(['O-', 'O+', 'A-', 'A+', 'B-', 'B+', 'AB-', 'AB+'] as $blood)
                                        <option value="{{ $blood }}" {{ old('tipo_sangre', $paciente->tipo_sangre) == $blood ? 'selected' : '' }}>{{ $blood }}</option>
                                    @endforeach
                                </select>
                                @error('tipo_sangre')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="direccion" id="direccion" rows="2" class="form-control @error('direccion') is-invalid @enderror" style="border-radius: 8px; border-color: var(--border-color);">{{ old('direccion', $paciente->direccion) }}</textarea>
                                @error('direccion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="antecedentes_medicos" id="antecedentes_medicos" rows="3" class="form-control @error('antecedentes_medicos') is-invalid @enderror" style="border-radius: 8px; border-color: var(--border-color);">{{ old('antecedentes_medicos', $paciente->antecedentes_medicos) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="alergias" id="alergias" rows="2" class="form-control @error('alergias') is-invalid @enderror" style="border-radius: 8px; border-color: var(--border-color);">{{ old('alergias', $paciente->alergias) }}</textarea>
                                @error('alergias')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="medicamentos_habituales" id="medicamentos_habituales" rows="2" class="form-control @error('medicamentos_habituales') is-invalid @enderror" style="border-radius: 8px; border-color: var(--border-color);">{{ old('medicamentos_habituales', $paciente->medicamentos_habituales) }}</textarea>
            ...
            <div class="col-12 col-lg-4">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="contacto_emergencia_nombre" id="contacto_emergencia_nombre" class="form-control @error('contacto_emergencia_nombre') is-invalid @enderror" value="{{ old('contacto_emergencia_nombre', $paciente->contacto_emergencia_nombre) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="contacto_emergencia_telefono" id="contacto_emergencia_telefono" class="form-control @error('contacto_emergencia_telefono') is-invalid @enderror" value="{{ old('contacto_emergencia_telefono', $paciente->contacto_emergencia_telefono) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="contacto_emergencia_parentesco" id="contacto_emergencia_parentesco" class="form-control @error('contacto_emergencia_parentesco') is-invalid @enderror" value="{{ old('contacto_emergencia_parentesco', $paciente->contacto_emergencia_parentesco) }}" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 16px; border: 1px solid var(--border-color) !important; background-color: #fafbfc;">
                    <div class="card-body p-4 d-flex flex-column gap-3">
                        ...
                        @else
                        <a href="{{ route('pacientes.index') }}" class="btn btn-outline-secondary w-100 py-3" style="border-radius: 10px; font-weight: 500; font-size: 0.95rem; text-align: center; text-decoration: none;">
                            Cancelar y volver
                        </a>
                        @endif
                    </div>
...
<script id="patients-data" type="application/json">
    {!! json_encode($existingPatients ?? []) !!}
</script>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const existingPatients = JSON.parse(document.getElementById('patients-data').textContent);
