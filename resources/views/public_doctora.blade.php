...
@section('title', 'La Doctora | Miradent Chimbote')
...
<section class="hero-doctora">
    <div class="hero-grid">
        ...
        <div class="hero-img-col photo-frame fade-up">
            <img src="{{ $doctora->avatar }}" alt="{{ $doctora->name }}">
        ...
        <div class="fade-up" style="animation-delay:0.15s;">
            ...
            <h1 class="hero-name">{{ $doctora->name ?: 'Dra. Miranda' }}</h1>

            @if($doctora->specialty)
                <p class="hero-specialty">{{ $doctora->specialty }}</p>
            @else
            ...
            <div class="hero-cop">
                ...
                {{ $doctora->cop ?: 'COP 50039' }} — Habilitada
            </div>

            <p class="hero-bio">
                {{ $doctora->bio ?: 'Especialista en estética dental, rehabilitación oral y diseño de sonrisa con más de 6 años de experiencia. En Miradent, cada tratamiento está pensado para devolverte la confianza y la salud de tu sonrisa.' }}
            </p>

            <div class="hero-btns">
                <a href="{{ $doctora->whatsapp_url }}" target="_blank" class="btn-jade-solid">
                    <i data-lucide="calendar-check" style="width:18px;height:18px;"></i>
                    Agendar Evaluación
                </a>
                <a href="{{ route('public.servicios') }}" class="btn-jade-outline">
        ...
        <div class="formacion-grid">
            ...
            <div class="formacion-item fade-up" style="animation-delay:0.1s;">
                ...
                <div>
                    ...
                    <div class="formacion-lugar">{{ $doctora->cop ?: 'COP 50039' }} — Activa</div>
                </div>
            </div>
...
<section class="quote-section">
    ...
    <div class="quote-author fade-up" style="animation-delay:0.2s;">
        — {{ $doctora->name ?: 'Dra. Miranda' }}, Fundadora de Miradent
    </div>
</section>
...
<section class="cta-section">
    <div class="fade-up">
        ...
        <div style="display:flex; gap:16px; justify-content:center; flex-wrap:wrap;">
            <a href="{{ $doctora->whatsapp_url }}" target="_blank" class="btn-jade-solid" style="font-size:1.05rem; padding:16px 36px;">
                <i data-lucide="message-circle" style="width:20px;height:20px;"></i>
                Escribir por WhatsApp
            </a>
            <a href="{{ route('public.reservar-cita') }}" class="btn-jade-outline" style="font-size:1.05rem; padding:16px 36px;">
