{{--
    Copia local de vendor/laravel/framework/.../pagination/resources/views/tailwind.blade.php.
    Se quitó el bloque "Showing X to Y of Z results": el admin ya muestra ese
    mismo resumen en español justo al lado (ver pacientes.blade.php y similares),
    así que el de Laravel solo duplicaba la información en inglés.
--}}
@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Navegación de paginación">
        ...
        <div class="hidden sm:flex sm:gap-2 sm:items-center sm:justify-end">
