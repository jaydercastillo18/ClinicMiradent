...
@section('title', 'Testimonios | Miradent')
...
<section class="testimonios-grid-container">
    <div class="container-premium">
        ...
        <div class="testimonios-grid">
            ...
            <div class="quote-card fade-up" {!! 'style="animation-delay: ' . ($loop->index * 0.1) . 's;"' !!}>
                ...
                <div class="quote-author">
                    ...
                    <div>
                        <div class="quote-author-name">{{ $testimonio->nombre_paciente }}</div>
        ...
        <div class="testimonios-action fade-up">
            <a href="{{ $doctora->whatsapp_url }}" target="_blank" class="btn-experience">
