                    ...
                    <div class="card h-100 border-0 shadow-sm overflow-hidden position-relative {{ !$caso->activo ? 'opacity-75' : '' }}" style="border-radius: 16px; border: 1px solid var(--border-color) !important; transition: all 0.2s;">
                        ...
                        <div class="d-flex" style="height: 180px; overflow: hidden; background-color: #f8fafc; border-bottom: 1px solid var(--border-color);">
                            ...
                            <div class="w-50 position-relative border-end" style="border-color: var(--border-color) !important;">
                                @if($caso->antes_img)
                                    <img src="{{ image_url($caso->antes_img, '', 'caso_antes', $caso->id) }}" class="w-100 h-100" style="object-fit: cover;" alt="Antes" loading="lazy">
                                @else
                            ...
                            <div class="w-50 position-relative">
                                @if($caso->despues_img)
                                    <img src="{{ image_url($caso->despues_img, '', 'caso_despues', $caso->id) }}" class="w-100 h-100" style="object-fit: cover;" alt="Después" loading="lazy">
                                @else
                                    <div class="w-100 h-100 d-flex align-items-center justify-content-center text-muted bg-white" style="background-color: #f2faf6; font-size: 0.85rem;">
                                        Sin foto Después
                                    </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            @if($caso->antes_img)
                                                <div class="mt-2 text-center">
                                                    <img src="{{ image_url($caso->antes_img, '', 'caso_antes', $caso->id) }}" class="rounded shadow-sm" style="max-height: 80px; max-width: 100%; object-fit: cover;">
                                                </div>
                                            @endif
                                        </div>
                                        <div class="col-6">
                                            ...
                                            @if($caso->despues_img)
                                                <div class="mt-2 text-center">
                                                    <img src="{{ image_url($caso->despues_img, '', 'caso_despues', $caso->id) }}" class="rounded shadow-sm" style="max-height: 80px; max-width: 100%; object-fit: cover;">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
