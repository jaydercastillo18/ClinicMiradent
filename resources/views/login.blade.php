...
<body>
    ...
    <img class="bg-logo" src="{{ asset('images/miradent_logo_vectorizado.svg') }}" alt="" role="presentation" aria-hidden="true">
        ...
        <div class="card">
            ...
            <div class="logo-area">
                <div class="logo-img-wrap">
                    <img src="{{ asset('images/miradent_logo_vectorizado.svg') }}" alt="Logo Miradent">
                </div>
