<?php $__env->startSection('title', 'Caja y Finanzas - Control General'); ?>
...
<div class="container-fluid p-0 finance-shell">
    ...
    <div class="finance-hero">
        ...
        <div class="finance-actions">
            <a href="<?php echo e(route('finanzas.pdf', request()->all())); ?>" class="btn btn-outline-danger d-flex align-items-center gap-2 px-3 py-2 finance-action" style="font-weight: 700;">
    ...
    <div id="caja-finanzas" class="card border-0 shadow-sm mb-5 finance-section">
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                ...
                <!-- Net Balance Card -->
                <div class="col-12 col-md-4">
                    <div class="card border-0 shadow-sm h-100" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                        'border-radius: 14px',
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="p-2 rounded-circle d-flex align-items-center justify-content-center" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                    'width: 32px',
                                    'height: 32px',
                                    'color: white',
                            ...
                            <h4 class="mb-1 fw-bold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                "font-family: 'Outfit', sans-serif",
                                'color: #047857' => $balance >= 0,
                                'color: #b91c1c' => $balance < 0,
                            ]) ?>">
                                S/. <?php echo e(number_format($balance, 2)); ?>
            ...
            <div class="card border-0 bg-light shadow-none mb-4 finance-filter-panel">
                <div class="card-body p-3">
                    ...
                    <form action="<?php echo e(route('finanzas.index')); ?>" method="GET" class="row g-3 align-items-end">
                        <!-- Preserved Cliente Filters -->
                        <input type="hidden" name="search_cliente" value="<?php echo e($search_cliente); ?>">
                        <input type="hidden" name="filtro_cliente" value="<?php echo e($filtro_cliente); ?>">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <div class="filter-search-control">
                                ...
                                <input type="text" name="search" class="form-control" placeholder="Paciente, tratamiento o gasto..." value="<?php echo e($search); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-2">
                            ...
                            <input type="month" name="mes" class="form-control" value="<?php echo e($mes); ?>">
                        </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-2">
                            ...
                            <select name="tipo" class="form-select">
                                <option value="" <?php echo e($tipo === '' || !$tipo ? 'selected' : ''); ?>>Todos</option>
                                <option value="ingreso" <?php echo e($tipo === 'ingreso' ? 'selected' : ''); ?>>Ingresos (Cobros)</option>
                                <option value="egreso" <?php echo e($tipo === 'egreso' ? 'selected' : ''); ?>>Egresos (Gastos)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-2">
                            ...
                            <select name="categoria" class="form-select">
                                <option value="" <?php echo e($categoria === '' || !$categoria ? 'selected' : ''); ?>>Todas</option>
                        ...
                        <div class="col-12 col-md-3 d-flex gap-2">
                            ...
                            <?php if($search || $tipo || $categoria || $mes !== \Carbon\Carbon::now()->format('Y-m')): ?>
                                <a href="<?php echo e(route('finanzas.index', ['search_cliente' => $search_cliente, 'filtro_cliente' => $filtro_cliente])); ?>" class="btn btn-light border d-flex align-items-center justify-content-center" style="height: 38px; width: 38px; border-radius: 8px; color: var(--text-muted);">
                            ...
                            <?php $__currentLoopData = $movimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="font-size: 0.85rem;">
                                    ...
                                    <td class="py-2.5 ps-3 fw-semibold text-slate-700">
                                        <?php echo e(\Carbon\Carbon::parse($mov->fecha)->format('d/m/Y')); ?>
                                    ...
                                    <!-- Concept / Patient -->
                                    <td class="py-2.5">
                                        <div class="fw-semibold text-slate-800"><?php echo e($mov->concepto); ?></div>
                                    </td>
                                    ...
                                    <td class="py-2.5">
                                        ...
                                        <?php else: ?>
                                            ...
                                            ?>
                                            <span class="badge fw-semibold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                    ...
                                    <td class="py-2.5">
                                        <?php if($mov->tipo === 'ingreso'): ?>
                                            ...
                                            ?>
                                            <span class="badge text-uppercase fw-semibold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                                'font-size: 0.65rem',
                                                'padding: 3px 8px',
                                                'border-radius: 6px',
                                                $comprobanteStyle
                                            ]) ?>">
                                                <?php echo e($comprobanteText); ?>

                                            </span>
                                        <?php else: ?>
                                            <span class="text-muted" style="font-size: 0.8rem;"><?php echo e($mov->comprobante_estado); ?></span>
                                        <?php endif; ?>
                                    </td>

                                    <!-- Amount -->
                                    <td class="py-2.5 text-end fw-bold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                        'font-size: 0.9rem',
                                        'color: #047857' => $mov->tipo === 'ingreso',
                                        'color: #dc2626' => $mov->tipo !== 'ingreso',
                                    ]) ?>">
                                        <?php echo e($mov->tipo === 'ingreso' ? '+' : '-'); ?>S/. <?php echo e(number_format($mov->monto, 2)); ?>
                                        ...
                                        <div class="d-flex justify-content-center gap-1">
                                            <?php if($mov->tipo === 'ingreso'): ?>
                                                ...
                                                <button type="button" class="btn btn-sm btn-light border p-1.5 edit-pago-btn"
                                                    ...
                                                    data-id="<?php echo e($mov->id); ?>"
                                                    data-update-url="<?php echo e(route('pagos.update', ['id' => $mov->id])); ?>"
                                                    data-paciente-id="<?php echo e($mov->detalles->paciente_id); ?>"
                                                    data-cita-id="<?php echo e($mov->detalles->cita_id ?? ''); ?>"
                                                    data-monto="<?php echo e($mov->detalles->monto); ?>"
                                                    data-metodo-pago="<?php echo e($mov->detalles->metodo_pago); ?>"
                                                    data-fecha-pago="<?php echo e(str_replace(' ', 'T', $mov->detalles->fecha_pago)); ?>"
                                                    data-estado="<?php echo e($mov->detalles->estado); ?>"
                                                    data-notas="<?php echo e($mov->detalles->notas); ?>"
                                                    style="border-radius: 6px;"
                                                    title="Editar Pago">
                                                    <i data-lucide="pencil" style="width: 12px; height: 12px; color: var(--text-muted);"></i>
                                                </button>
                                                <!-- Delete Pago Form -->
                                                <form action="<?php echo e(route('pagos.destroy', $mov->id)); ?>" method="POST" data-axios-delete data-axios-no-reload="true" data-confirm="¿Está seguro de que desea anular este pago?" style="display:inline-block;">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <button type="button" class="btn btn-sm btn-light border p-1.5 edit-gasto-btn"
                                                    data-id="<?php echo e($mov->id); ?>"
                                                    data-update-url="<?php echo e(route('gastos.update', ['id' => $mov->id])); ?>"
                                                    data-concepto="<?php echo e($mov->detalles->concepto); ?>"
                                                    data-descripcion="<?php echo e($mov->detalles->descripcion); ?>"
                                                    data-monto="<?php echo e($mov->detalles->monto); ?>"
                                                    data-categoria="<?php echo e($mov->detalles->categoria); ?>"
                                                    data-metodo="<?php echo e($mov->detalles->metodo_pago); ?>"
                                                    data-fecha="<?php echo e(\Carbon\Carbon::parse($mov->detalles->fecha_gasto)->format('Y-m-d')); ?>"
                                                    data-comprobante="<?php echo e($mov->detalles->comprobante); ?>"
                                                    data-ui-toggle="modal" data-ui-target="#editGastoModal"
                                                    style="border-radius: 6px;" title="Editar Gasto">
                                                    <i data-lucide="pencil" style="width: 12px; height: 12px; color: var(--text-muted);"></i>
                                                </button>
                                                <!-- Delete Gasto Form -->
                                                <form action="<?php echo e(route('gastos.destroy', $mov->id)); ?>" method="POST" data-axios-delete data-axios-no-reload="true" data-confirm="¿Eliminar este gasto?" style="display:inline-block;">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                        ...
                        <tfoot class="bg-white" style="background-color: #f2faf6;">
                            <tr style="font-size: 0.85rem;">
                                ...
                                <td class="py-2.5 text-end fw-bold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                    ...
                                    Balance: S/. <?php echo e(number_format($balance, 2)); ?>
        ...
        <div class="card-body p-4">
            ...
            <div class="row row-cols-2 row-cols-md-5 g-2.5 mb-4 client-kpis">
                ...
                <div class="col">
                        ...
                        <h5 class="mb-0 fw-bold text-slate-800"><?php echo e($clienteCounts['todos']); ?></h5>
                    </div>
                </div>
                <!-- Al día -->
                <div class="col">
                    <div class="p-3 border rounded-3 text-center" style="border-radius: 12px !important; background-color: #f0fdf4; border-color: #bbf7d0 !important;">
                        ...
                        <h5 class="mb-0 fw-bold" style="color: #15803d;"><?php echo e($clienteCounts['pagado']); ?></h5>
                    </div>
                </div>
                <!-- Por cuotas -->
                <div class="col">
                    <div class="p-3 border rounded-3 text-center" style="border-radius: 12px !important; background-color: #fefbeb; border-color: #fef08a !important;">
                        ...
                        <h5 class="mb-0 fw-bold" style="color: #a16207;"><?php echo e($clienteCounts['cuotas']); ?></h5>
                    </div>
                </div>
                <!-- Pendientes -->
                <div class="col">
                    <div class="p-3 border rounded-3 text-center" style="border-radius: 12px !important; background-color: #fff7ed; border-color: #ffedd5 !important;">
                        ...
                        <h5 class="mb-0 fw-bold" style="color: #9a3412;"><?php echo e($clienteCounts['pendiente']); ?></h5>
                    </div>
                </div>
                <!-- Morosos -->
                <div class="col">
                    <div class="p-3 border rounded-3 text-center" style="border-radius: 12px !important; background-color: #f2faf6; border-color: #fecaca !important;">
                        ...
                        <h5 class="mb-0 fw-bold" style="color: #b91c1c;"><?php echo e($clienteCounts['moroso']); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 bg-light shadow-none mb-4 finance-filter-panel">
                <div class="card-body p-3">
                    ...
                    <form action="<?php echo e(route('finanzas.index')); ?>" method="GET" class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="filter-search-control">
                                <i data-lucide="search"></i>
                                <input type="text" name="search_cliente" class="form-control" placeholder="Nombre, apellido o DNI..." value="<?php echo e($search_cliente); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-8 d-flex flex-wrap gap-1.5 justify-content-md-end">
                            ...
                            <a href="<?php echo e(route('finanzas.index', array_merge(request()->query(), ['filtro_cliente' => '']))); ?>" 
                               class="btn btn-sm py-1.5 px-3 rounded-pill fw-semibold <?php echo e($curFilter === 'todos' || $curFilter === '' ? 'btn-secondary text-white' : 'btn-outline-secondary bg-white'); ?>" style="font-size: 0.78rem;">
                                Todos (<?php echo e($clienteCounts['todos']); ?>)
                            </a>

                            <a href="<?php echo e(route('finanzas.index', array_merge(request()->query(), ['filtro_cliente' => 'pagado']))); ?>" 
                               class="btn btn-sm py-1.5 px-3 rounded-pill fw-semibold <?php echo e($curFilter === 'pagado' ? 'btn-primary text-white' : 'btn-outline-success bg-white'); ?>" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                   'font-size: 0.78rem',
                            ...
                            <a href="<?php echo e(route('finanzas.index', array_merge(request()->query(), ['filtro_cliente' => 'cuotas']))); ?>" 
                               class="btn btn-sm py-1.5 px-3 rounded-pill fw-semibold <?php echo e($curFilter === 'cuotas' ? 'btn-primary text-dark' : 'btn-outline-warning bg-white'); ?>" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                   'font-size: 0.78rem',
                            ...
                            <a href="<?php echo e(route('finanzas.index', array_merge(request()->query(), ['filtro_cliente' => 'pendiente']))); ?>" 
                               class="btn btn-sm py-1.5 px-3 rounded-pill fw-semibold <?php echo e($curFilter === 'pendiente' ? 'btn-secondary text-white' : 'btn-outline-secondary bg-white'); ?>" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                   'font-size: 0.78rem',
                            ...
                            <a href="<?php echo e(route('finanzas.index', array_merge(request()->query(), ['filtro_cliente' => 'moroso']))); ?>" 
                               class="btn btn-sm py-1.5 px-3 rounded-pill fw-semibold <?php echo e($curFilter === 'moroso' ? 'btn-primary text-white' : 'btn-outline-danger bg-white'); ?>" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                   'font-size: 0.78rem',
                            ...
                            <?php if($search_cliente || $filtro_cliente): ?>
                                <a href="<?php echo e(route('finanzas.index', ['search' => $search, 'mes' => $mes, 'tipo' => $tipo, 'categoria' => $categoria])); ?>" 
            ...
            <ul class="nav nav-pills-modern mb-3" id="deudores-tab" role="tablist" style="background: #f1f5f9; padding: 4px; border-radius: 10px; display: inline-flex; border: 1px solid #e2e8f0;">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="con-deuda-tab" data-ui-toggle="pill" data-ui-target="#con-deuda" type="button" role="tab" style="color: #64748b; font-weight: 600; border-radius: 8px; padding: 6px 16px; font-size: 0.85rem; border: none; background: transparent; transition: all 0.2s;">
                        <i data-lucide="alert-circle" style="width: 14px; height: 14px; margin-right: 4px;"></i> Con Deuda (<?php echo e($pacientesConFinanzas->where('pending_amount', '>', 0)->count()); ?>)
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="sin-deuda-tab" data-ui-toggle="pill" data-ui-target="#sin-deuda" type="button" role="tab" style="color: #64748b; font-weight: 600; border-radius: 8px; padding: 6px 16px; font-size: 0.85rem; border: none; background: transparent; transition: all 0.2s;">
                        <i data-lucide="check-circle-2" style="width: 14px; height: 14px; margin-right: 4px;"></i> Al Día (<?php echo e($pacientesConFinanzas->where('pending_amount', '<=', 0)->count()); ?>)
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="deudores-tabContent">
                ...
                <div class="tab-pane fade show active" id="con-deuda" role="tabpanel">
                    <?php $deudores = $pacientesConFinanzas->where('pending_amount', '>', 0); ?>
                    <?php if($deudores->isEmpty()): ?>
                        <div class="text-center p-5 border rounded-3 bg-white">
                    ...
                    <?php else: ?>
                        <div class="table-responsive border rounded-3 bg-white finance-table-card">
                            <table class="table table-hover align-middle text-nowrap mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $deudores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            ...
                                            <td class="py-2.5 ps-3">
                                                <div class="d-flex align-items-center gap-2.5">
                                                    <div class="d-flex align-items-center justify-content-center fw-bold text-uppercase" style="width: 36px; height: 36px; background-color: #fee2e2; color: #b91c1c; border-radius: 8px; font-size: 0.8rem; font-family: 'Outfit', sans-serif;">
                                                        <?php echo e(substr($p->nombre, 0, 1) . substr($p->apellido, 0, 1)); ?>

                                                    </div>
                                                    <div>
                                                        <div class="fw-semibold text-slate-800" style="font-size: 0.88rem;"><?php echo e($p->nombre); ?> <?php echo e($p->apellido); ?></div>
                                                        <div class="text-muted small" style="font-size: 0.72rem;">DNI: <?php echo e($p->dni); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-2.5">
                                                <span class="badge fw-semibold text-uppercase" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                                    ...
                                                    <?php echo e($pagoStyle['label']); ?>

                                                </span>
                                            </td>
                                            <td class="py-2.5 fw-bold" style="color: #dc2626;">
                                                S/. <?php echo e(number_format($p->pending_amount, 2)); ?>

                                            </td>
                                            <td class="py-2.5">
                                                <div class="client-due <?php echo e($p->estado_pago === 'moroso' ? 'overdue' : ''); ?>">
                                                    <span class="client-due-date"><?php echo e(\Carbon\Carbon::parse($p->next_due_date)->format('d/m/Y')); ?></span>
                                                    <span class="client-due-note">
                                                        <?php if($p->estado_pago === 'moroso'): ?>
                                                            Vencido hace <?php echo e($daysOverdue); ?> <?php echo e($daysOverdue === 1 ? 'día' : 'días'); ?>

                                                        <?php elseif($daysUntilDue === 0): ?>
                                                            Vence hoy
                                                        <?php else: ?>
                                                            Faltan <?php echo e($daysUntilDue); ?> <?php echo e($daysUntilDue === 1 ? 'día' : 'días'); ?>
                                            ...
                                            <td class="py-2.5 text-center pe-3">
                                                <div class="d-flex justify-content-center gap-1.5">
                                                    <?php if($p->estado_pago === 'moroso'): ?>
                                                        ...
                                                        ?>
                                                        <a href="<?php echo e($waUrl); ?>" target="_blank" class="btn btn-sm btn-primary p-1.5 d-flex align-items-center justify-content-center action-mini-btn" style="background-color: #25d366; border-color: #25d366; color: white;" title="Enviar cobranza por WhatsApp">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 24 24">
                                                              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                                                            </svg>
                                                        </a>
                                                    <?php endif; ?>
                                                    <button type="button" class="btn btn-sm btn-outline-primary p-1.5 d-flex align-items-center justify-content-center show-cliente-history-btn action-mini-btn" data-ui-toggle="modal" data-ui-target="#clienteHistoryModal" data-nombre="<?php echo e($p->nombre); ?> <?php echo e($p->apellido); ?>" data-pagos="<?php echo e(json_encode($p->pagos)); ?>" title="Ver Historial">
                                                        <i data-lucide="history" style="width: 12px; height: 12px;"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-outline-success p-1.5 d-flex align-items-center justify-content-center register-pago-quick-btn action-mini-btn" data-ui-toggle="modal" data-ui-target="#createPagoModal" data-paciente-id="<?php echo e($p->id); ?>" data-monto="<?php echo e($p->pending_amount); ?>" title="Cobrar Deuda">
                ...
                <div class="tab-pane fade" id="sin-deuda" role="tabpanel">
                    <?php $pagados = $pacientesConFinanzas->where('pending_amount', '<=', 0); ?>
                    <?php if($pagados->isEmpty()): ?>
                        <div class="text-center p-5 border rounded-3 bg-white">
                            <div class="p-3 mx-auto mb-3 bg-light rounded-circle text-muted d-flex align-items-center justify-content-center" style="width: 64px; height: 64px;">
                    ...
                    <?php else: ?>
                        <div class="table-responsive border rounded-3 bg-white finance-table-card">
                            <table class="table table-hover align-middle text-nowrap mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pagados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="font-size: 0.85rem;">
                                            <td class="py-2.5 ps-3">
                                                <div class="d-flex align-items-center gap-2.5">
                                            ...
                                            <td class="py-2.5 text-center pe-3">
                                                <div class="d-flex justify-content-center gap-1.5">
                                                    <button type="button" class="btn btn-sm btn-outline-primary p-1.5 d-flex align-items-center justify-content-center show-cliente-history-btn action-mini-btn" data-ui-toggle="modal" data-ui-target="#clienteHistoryModal" data-nombre="<?php echo e($p->nombre); ?> <?php echo e($p->apellido); ?>" data-pagos="<?php echo e(json_encode($p->pagos)); ?>" title="Ver Historial de Pagos">
                                                        <i data-lucide="history" style="width: 12px; height: 12px;"></i>
                                                    </button>
                                                </div>
                                            </td>
...
<div class="modal fade" id="createPagoModal" tabindex="-1" aria-labelledby="createPagoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            ...
            <form action="<?php echo e(route('pagos.store')); ?>" method="POST" data-axios-submit data-axios-reset="true" data-axios-no-reload="true" data-axios-close-modal="true">
                <?php echo csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="cita_id" id="create_cita_id" class="form-select select-cita" style="border-radius: 8px; height: 42px; border-color: var(--border-color); font-size: 0.875rem;">
                                ...
                                <?php $__currentLoopData = $citas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cita->id); ?>" data-paciente-id="<?php echo e($cita->paciente_id); ?>" style="display: none;">
                                        <?php echo e(\Carbon\Carbon::parse($cita->fecha_hora)->format('d/m/Y H:i')); ?> - <?php echo e($cita->servicio?->nombre ?? 'Tratamiento'); ?>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="datetime-local" name="fecha_pago" id="create_pago_fecha" class="form-control" required value="<?php echo e(date('Y-m-d\TH:i')); ?>" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="cita_id" id="edit_cita_id" class="form-select select-cita" style="border-radius: 8px; height: 42px; border-color: var(--border-color); font-size: 0.875rem;">
                                <option value="" data-paciente-id="all">-- Sin cita vinculada / Pago General --</option>
                                <?php $__currentLoopData = $citas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cita->id); ?>" data-paciente-id="<?php echo e($cita->paciente_id); ?>">
                                        <?php echo e(\Carbon\Carbon::parse($cita->fecha_hora)->format('d/m/Y H:i')); ?> - <?php echo e($cita->servicio?->nombre ?? 'Tratamiento'); ?>
...
<div class="modal fade" id="createGastoModal" tabindex="-1" aria-labelledby="createGastoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            ...
            <form action="<?php echo e(route('gastos.store')); ?>" method="POST" data-axios-submit data-axios-reset="true" data-axios-no-reload="true" data-axios-close-modal="true">
                <?php echo csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <!-- Concepto -->
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="date" name="fecha_gasto" id="create_gasto_fecha" class="form-control" required value="<?php echo e(date('Y-m-d')); ?>" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                        </div>
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/finanzas.blade.php ENDPATH**/ ?>