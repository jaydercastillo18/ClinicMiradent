...
<div class="container-fluid p-0">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4 pb-2 border-bottom">
        <div>
            <h1 class="h3 mb-1 text-slate-800" style="font-weight: 700; color: var(--text-main);">Bienvenida de nuevo, <?php echo e(Auth::user()->name); ?></h1>
            <p class="text-muted mb-0" style="font-size: 0.95rem;">Resumen de la clínica dental Miradent para hoy.</p>
        </div>
        <div>
            <a href="<?php echo e(url('/admin/citas')); ?>" class="btn btn-primary  d-flex align-items-center gap-2" style="background-color: var(--primary); border-color: var(--primary); font-weight: 500; padding: 10px 18px; border-radius: 10px; box-shadow: 0 4px 12px rgba(32,127,84,0.2);">
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px; transition: transform 0.2s; background: white; border: 1px solid var(--border-color) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div class="stat-card-text">
                        ...
                        <h3 class="stat-card-value mb-0" style="color: var(--text-main);"><?php echo e(number_format($pacienteCount)); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px; transition: transform 0.2s; background: white; border: 1px solid var(--border-color) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div class="stat-card-text">
                        ...
                        <h3 class="stat-card-value mb-0" style="color: var(--text-main);"><?php echo e($citasHoyCount); ?></h3>
                        <span class="text-muted d-flex align-items-center gap-1 mt-2" style="font-size: 0.85rem;">
                            <i data-lucide="clock" style="width: 14px; height: 14px;"></i> <?php echo e($citasCompletadasHoyCount); ?> completadas
                        </span>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px; transition: transform 0.2s; background: white; border: 1px solid var(--border-color) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div class="stat-card-text">
                        ...
                        <h3 class="stat-card-value stat-card-value-currency mb-0" style="color: var(--text-main);">S/. <?php echo e(number_format($ingresosMes, 2)); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px; transition: transform 0.2s; background: white; border: 1px solid var(--border-color) !important;">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div class="stat-card-text">
                        ...
                        <h3 class="stat-card-value mb-0" style="color: var(--text-main);"><?php echo e($serviciosCount); ?></h3>
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm" style="border-radius: 16px; border: 1px solid var(--border-color) !important;">
                <div class="card-header bg-white border-bottom py-3 px-4 d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <a href="<?php echo e(url('/admin/citas')); ?>" class="btn btn-link p-0 text-primary text-decoration-none" style="color: var(--primary) !important; font-weight: 600; font-size: 0.9rem;">Ver agenda completa</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-nowrap mb-0" style="font-size: 0.925rem;">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $citasHoy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-placeholder d-flex align-items-center justify-content-center text-white font-weight-bold" style="width: 36px; height: 36px; background-color: var(--primary); border-radius: 50%; font-size: 0.85rem; font-weight: 600;">
                                                <?php echo e(substr($cita->paciente?->nombre ?? '?', 0, 1)); ?><?php echo e(substr($cita->paciente?->apellido ?? '', 0, 1)); ?>

                                            </div>
                                            <div>
                                                <span class="d-block font-weight-600" style="font-weight: 600; color: var(--text-main);"><?php echo e($cita->paciente?->nombre ?? '(sin paciente)'); ?> <?php echo e($cita->paciente?->apellido ?? ''); ?></span>
                                                <span class="text-muted d-block" style="font-size: 0.775rem;">DNI: <?php echo e($cita->paciente?->dni ?? '—'); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td><?php echo e($cita->servicio ? $cita->servicio->nombre : 'Consulta General'); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($cita->estado === 'en_espera'): ?>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-light text-dark px-2.5 py-1.5" style="font-weight: 600; background-color: #f2faf6 !important; color: #1b5c3a !important;"><?php echo e(ucfirst($cita->estado)); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="pe-4 text-end">
                                        <a href="<?php echo e(url('/admin/citas')); ?>" class="btn btn-outline-secondary btn-sm rounded-3" style="font-size: 0.8rem; border-color: var(--border-color);">
                                            Ver Agenda
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="5" class="py-5 text-center text-muted">
                                        ...
                                        <a href="<?php echo e(url('/admin/citas')); ?>" class="btn btn-link text-primary text-decoration-none mt-2" style="color: var(--primary) !important; font-weight: 600; font-size: 0.875rem;">Programar Cita</a>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px; border: 1px solid var(--border-color) !important;">
                ...
                <div class="card-body p-4 d-flex flex-column gap-3">
                    <a href="<?php echo e(url('/admin/pacientes')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none border hover-action" style="transition: all 0.2s; border-color: var(--border-color) !important; background-color: var(--bg-body);">
                        <div class="d-flex align-items-center gap-3">
                    ...
                    <?php if(auth()->user()->role === 'doctora'): ?>
                    <a href="<?php echo e(route('finanzas.index')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none border hover-action" style="transition: all 0.2s; border-color: var(--border-color) !important; background-color: var(--bg-body);">
                        <div class="d-flex align-items-center gap-3">
                            <div class="p-2 bg-white rounded-3 text-primary" style="box-shadow: var(--shadow-sm);">
                    ...
                    <a href="<?php echo e(route('promociones.index')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none border hover-action" style="transition: all 0.2s; border-color: var(--border-color) !important; background-color: var(--bg-body);">
                        <div class="d-flex align-items-center gap-3">
                            <div class="p-2 bg-white rounded-3 text-primary" style="box-shadow: var(--shadow-sm);">
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/dashboard.blade.php ENDPATH**/ ?>