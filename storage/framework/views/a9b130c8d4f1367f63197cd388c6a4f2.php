<?php $__env->startSection('title', 'Campañas Promocionales'); ?>
...
<div class="container-fluid p-0">
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px; border: 1px solid var(--border-color) !important;">
        <div class="card-body p-4">
            <form action="<?php echo e(route('promociones.index')); ?>" method="GET" class="row g-3">
                <div class="col-12 col-md-6">
                    ...
                    <div class="input-group" style="flex-wrap: nowrap;">
                        ...
                        <input type="text" name="search" class="form-control bg-light border-start-0 ps-0 shadow-none" placeholder="Título o descripción de la campaña..." value="<?php echo e(request('search')); ?>" style="border-radius: 0 10px 10px 0; border-color: var(--border-color); height: 42px; font-size: 0.85rem;">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    ...
                    <select name="status" class="form-select bg-white" style="background-color: #f2faf6; border-radius: 10px; border-color: var(--border-color); height: 42px; font-size: 0.85rem;">
                        <option value="Todas" <?php echo e(request('status') === 'Todas' ? 'selected' : ''); ?>>Todas</option>
                        <option value="activas" <?php echo e(request('status') === 'activas' ? 'selected' : ''); ?>>Activas</option>
                        <option value="inactivas" <?php echo e(request('status') === 'inactivas' ? 'selected' : ''); ?>>Inactivas</option>
                    </select>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('promociones.index')); ?>" class="btn btn-light border d-flex align-items-center justify-content-center" style="height: 42px; width: 50px; border-radius: 10px; color: var(--text-muted);">
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-12 col-md-6 col-lg-4" data-axios-removable>
            <div class="card h-100 border-0 shadow-sm overflow-hidden position-relative <?php echo e(!$promo->activo || $isExpired ? 'opacity-75' : ''); ?>" style="border-radius: 16px; border: 1px solid var(--border-color) !important; transition: all 0.2s;">
                ...
                <span class="position-absolute top-0 start-0 m-3 badge shadow-sm" style="background-color: var(--primary); color: white; border-radius: 8px; z-index: 10; font-size: 0.75rem; padding: 6px 10px;">
                    <?php echo e($promo->descuento_porcentaje); ?>% DCTO
                </span>
                <?php endif; ?>
                ...
                ?>
                <span class="position-absolute top-0 end-0 m-3 badge px-3 py-2 shadow-sm text-uppercase fw-bold" <?php echo $fullStyleAttr; ?>>
                    <?php echo e($promoStatusLabel); ?>

                </span>

                <!-- Header banner image -->
                <div class="position-relative" style="height: 180px; overflow: hidden; background-color: #f8fafc;">
                    <?php if($promo->imagen_path): ?>
                    <img src="<?php echo e(asset($promo->imagen_path)); ?>" class="w-100 h-100" style="object-fit: cover;" alt="<?php echo e($promo->titulo); ?>" loading="lazy">
                    <?php else: ?>
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <p class="text-muted mb-4 flex-grow-1" style="font-size: 0.85rem; line-height: 1.5;">
                        <?php echo e($promo->descripcion ?: 'Sin descripción detallada.'); ?>
                    ...
                    <div class="border-top border-light-subtle pt-3 mt-auto">
                        ...
                        <div class="fw-medium text-slate-700" style="font-size: 0.85rem; padding-left: 22px;">
                            ...
                            <?php echo e($promo->fecha_inicio ? \Carbon\Carbon::parse($promo->fecha_inicio)->format('d/m/Y') : 'Inicio inmediato'); ?>

                            al
                            <?php echo e($promo->fecha_fin ? \Carbon\Carbon::parse($promo->fecha_fin)->format('d/m/Y') : 'Indefinido'); ?>
                ...
                <div class="card-footer bg-light border-top-0 px-4 py-3 d-flex justify-content-between align-items-center">
                    ...
                    <form action="<?php echo e(route('promociones.update', $promo->id)); ?>" method="POST" class="d-inline" data-axios-submit data-axios-refresh="true">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="hidden" name="titulo" value="<?php echo e($promo->titulo); ?>">
                        <input type="hidden" name="descuento_porcentaje" value="<?php echo e($promo->descuento_porcentaje); ?>">
                        <input type="hidden" name="fecha_inicio" value="<?php echo e($promo->fecha_inicio); ?>">
                        <input type="hidden" name="fecha_fin" value="<?php echo e($promo->fecha_fin); ?>">
                        <input type="hidden" name="descripcion" value="<?php echo e($promo->descripcion); ?>">
                        <input type="hidden" name="activo" value="<?php echo e($promo->activo ? 0 : 1); ?>">
                        <div class="form-check form-switch p-0 m-0 d-flex align-items-center gap-2" style="cursor: pointer;">
                            <input class="form-check-input m-0" type="checkbox" role="switch" onchange="this.form.requestSubmit()" <?php echo e($promo->activo ? 'checked' : ''); ?> style="cursor: pointer; width: 36px; height: 20px;">
                            <span class="fw-semibold text-slate-600" style="font-size: 0.8rem;">
                                <?php echo e($promo->activo ? 'Visible' : 'Oculto'); ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-sm btn-light border p-2 edit-promo-btn"
                            ...
                            data-id="<?php echo e($promo->id); ?>"
                            data-update-url="<?php echo e(route('promociones.update', $promo->id)); ?>"
                            data-titulo="<?php echo e($promo->titulo); ?>"
                            data-descripcion="<?php echo e($promo->descripcion); ?>"
                            data-descuento="<?php echo e($promo->descuento_porcentaje); ?>"
                            data-fecha-inicio="<?php echo e($promo->fecha_inicio); ?>"
                            data-fecha-fin="<?php echo e($promo->fecha_fin); ?>"
                            data-activo="<?php echo e($promo->activo); ?>"
                            data-imagen="<?php echo e($promo->imagen_path ? asset($promo->imagen_path) : ''); ?>"
                            title="Editar Campaña">
                            <i data-lucide="edit-3" style="width: 14px; height: 14px; color: var(--text-muted);"></i>
                        </button>

                        <!-- Delete Form -->
                        <form action="<?php echo e(route('promociones.destroy', $promo->id)); ?>" method="POST" data-axios-delete data-confirm="¿Está seguro de que desea eliminar esta promoción?">
                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="createPromoModal" tabindex="-1" aria-labelledby="createPromoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            ...
            <form action="<?php echo e(route('promociones.store')); ?>" method="POST" enctype="multipart/form-data" data-axios-submit data-axios-reset="true" data-axios-refresh="true">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/promociones.blade.php ENDPATH**/ ?>