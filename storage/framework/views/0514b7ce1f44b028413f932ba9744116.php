                            ...
                            <tr data-axios-removable style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
                                <td class="px-4 py-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <span class="d-block fw-bold text-slate-800" style="font-size: 0.95rem; color: #0f172a;"><?php echo e($user->name); ?></span>
                                ...
                                <td class="px-4 py-3 text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <button class="btn btn-sm d-flex align-items-center justify-content-center" data-user="<?php echo e($user); ?>" onclick="openEditUsuarioModal(JSON.parse(this.dataset.user))" style="width: 34px; height: 34px; background-color: #f1f5f9; color: #475569; border: none; border-radius: 8px; transition: all 0.2s;" title="Editar Usuario" onmouseover="this.style.backgroundColor='#e2e8f0'; this.style.color='#0f172a';" onmouseout="this.style.backgroundColor='#f1f5f9'; this.style.color='#475569';">
                                            <i data-lucide="edit-2" style="width: 16px; height: 16px;"></i>
                                        </button>
                                        <?php if($user->id !== auth()->id()): ?>
                                            <form action="<?php echo e(route('usuarios.destroy', $user->id)); ?>" method="POST" data-axios-delete data-confirm="¿Está seguro de que desea eliminar a este usuario? Ya no podrá acceder al sistema." class="d-inline">
                                                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="newUsuarioModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
            ...
            <form action="<?php echo e(route('usuarios.store')); ?>" method="POST" data-axios-submit data-axios-reset="true" data-axios-refresh="true">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/usuarios.blade.php ENDPATH**/ ?>