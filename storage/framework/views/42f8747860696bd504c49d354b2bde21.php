<?php $__env->startSection('title', 'Registro de Auditoría'); ?>
...
<script>
    ...
    function loadAuditLogs(page = 1) {
        ...
        axios.get(`<?php echo e(route('auditoria.index')); ?>?page=${page}`)
            .then(response => {
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/auditoria.blade.php ENDPATH**/ ?>