<?php $__env->startSection('title', 'Miradent Centro Odontológico'); ?>
...
<div class="home-page">
        ...
        <div class="home-shell home-hero-grid">
            <div>
                ...
                <div class="home-actions">
                    <a href="<?php echo e(route('public.reservar-cita')); ?>" class="home-btn home-btn-primary">
                        <i data-lucide="calendar-check"></i>
                        Reservar cita
                    </a>
                    <a href="<?php echo e(route('public.servicios')); ?>" class="home-btn home-btn-secondary">
            ...
            <div class="home-visual">
                <div class="home-portrait">
                    <?php if($heroImage): ?>
                    <img src="<?php echo e($heroImage); ?>" alt="Miradent atención dental premium">
                    <?php else: ?>
                    <div class="home-portrait-fallback">
                        <img src="<?php echo e($publicAssets->logo); ?>" alt="Miradent">
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="home-floating-badge" style="top: 84px; right: 24px; animation-delay: 1.5s;">
                        ...
                        <?php echo e($doctora->cop ?: 'COP-50039'); ?>
                    ...
                    <div class="home-status-card">
                        ...
                        <div>
                            <strong><?php echo e($doctora->name ?: 'Atención Miradent'); ?></strong>
                            <span><?php echo e($doctora->specialty ?: 'Odontología integral y estética'); ?></span>
                        </div>
        ...
        <div class="home-shell" style="position: relative; z-index: 2;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: stretch;">
                ...
                <div style="flex: 1 1 400px; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; align-content: start;">
                    <?php $__currentLoopData = $loMasImportante; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 20px; padding: 24px 20px; backdrop-filter: blur(10px); transition: transform 0.3s ease, background 0.3s ease, border-color 0.3s ease;" onmouseover="this.style.background='rgba(255, 255, 255, 0.06)'; this.style.transform='translateY(-6px)'; this.style.borderColor='rgba(0,168,132,0.4)';" onmouseout="this.style.background='rgba(255, 255, 255, 0.03)'; this.style.transform='translateY(0)'; this.style.borderColor='rgba(255, 255, 255, 0.08)';">
                        <div style="width: 48px; height: 48px; border-radius: 14px; background: rgba(0, 168, 132, 0.15); color: var(--home-jade-100); display: flex; align-items: center; justify-content: center; margin-bottom: 16px; border: 1px solid rgba(0, 168, 132, 0.3); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                            <i data-lucide="<?php echo e($item['icon']); ?>" style="width: 24px; height: 24px;"></i>
                        </div>
                        <h3 style="color: var(--home-white); font-size: 1.15rem; font-weight: 700; margin-bottom: 10px; font-family: 'Outfit', sans-serif; letter-spacing: -0.02em; line-height: 1.3;"><?php echo e($item['title']); ?></h3>
                        <p style="color: var(--home-jade-100); opacity: 0.75; font-size: 0.95rem; line-height: 1.5; margin: 0;"><?php echo e($item['desc']); ?></p>
                    </article>
    ...
    <section class="home-section home-section-soft">
        <div class="home-shell">
            <div class="home-section-head">
                ...
                <a href="<?php echo e(route('public.servicios')); ?>" class="home-link">
                    Ver catálogo completo <i data-lucide="arrow-right"></i>
                </a>
            </div>

            <div class="home-services-grid">
                <?php $__empty_1 = true; $__currentLoopData = $serviciosHome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="home-card home-service-card fade-up">
                    <div class="home-service-media">
                        ...
                        <?php else: ?>
                        <div class="home-portrait-fallback">
                            <i data-lucide="<?php echo e($servicio->category_icon); ?>" style="width:64px;height:64px;"></i>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="home-service-body">
                        <span class="home-tag"><?php echo e($servicio->category ?: 'Tratamiento'); ?></span>
                        <h3 style="margin-top:14px;"><?php echo e($servicio->name); ?></h3>
                        <p><?php echo e($servicio->description_home); ?></p>
                        <div class="home-service-meta">
                            <div>
                                <div class="home-duration"><?php echo e($servicio->duration); ?> min</div>
                                <div class="home-price"><?php echo e($servicio->price_display); ?></div>
                            </div>
                            <button
                                type="button"
                ...
                <article class="home-card fade-up">
                    ...
                    <a href="<?php echo e(route('public.reservar-cita')); ?>" class="home-link" style="margin-top:18px;">Reservar evaluación</a>
                </article>
                <?php endif; ?>
            </div>
        </div>
    ...
    <!-- INSTALACIONES -->
    <?php if($instalaciones && $instalaciones->count() > 0): ?>
        ...
        <div class="home-shell">
            ...
            <div class="instalaciones-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 24px;">
                ...
                <div style="border-radius: 24px; overflow: hidden; box-shadow: var(--home-shadow); position: relative; aspect-ratio: 4/3;">
                    <img src="<?php echo e(asset($inst->imagen_path)); ?>" alt="<?php echo e($inst->titulo); ?>" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'" loading="lazy">
                    <?php if($inst->titulo): ?>
                    <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 24px; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); color: white;">
                        <h4 style="margin: 0; font-size: 1.1rem; font-weight: 600;"><?php echo e($inst->titulo); ?></h4>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($loMasImportante) && count($loMasImportante) > 0): ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 32px;">
                ...
                <div style="background: var(--home-white); padding: 40px 32px; border-radius: 24px; box-shadow: 0 10px 30px rgba(0,168,132,0.05); text-align: center; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                    <div style="width: 64px; height: 64px; background: var(--home-jade-100); color: var(--home-jade-600); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px;">
                        <i data-lucide="<?php echo e($item['icon']); ?>" style="width: 32px; height: 32px;"></i>
                    </div>
                    <h3 style="font-size: 1.25rem; color: var(--home-jade-950); margin-bottom: 16px;"><?php echo e($item['title']); ?></h3>
                    <p style="color: var(--home-slate-600); line-height: 1.6; margin: 0;"><?php echo e($item['desc']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="home-shell">
            <div class="home-results">
                <div class="home-results-copy">
                    ...
                    <div class="home-actions">
                        <a href="<?php echo e(route('public.casos')); ?>" class="home-btn home-btn-secondary">
                            Ver resultados reales
                        </a>
                    </div>
                </div>

                <?php if($casoPrincipal && $casoPrincipal->has_images): ?>
                <article class="home-case-card home-case-card-feature fade-up">
                    <div class="home-case-compare" tabindex="0" aria-label="Comparador de antes y después: <?php echo e($casoPrincipal->title); ?>">
                        <img class="home-case-image home-case-image-after" src="<?php echo e($casoPrincipal->after_image); ?>" alt="Después: <?php echo e($casoPrincipal->title); ?>" draggable="false" loading="lazy">
                        <img class="home-case-image home-case-image-before" src="<?php echo e($casoPrincipal->before_image); ?>" alt="Antes: <?php echo e($casoPrincipal->title); ?>" draggable="false" loading="lazy">
                    ...
                    <div class="home-case-body">
                        <h3><?php echo e($casoPrincipal->title); ?></h3>
                        <p><?php echo e($casoPrincipal->description_short); ?></p>
                    </div>
                </article>
                <?php else: ?>
                <article class="home-card fade-up">
    ...
    <section class="home-section home-promo-section" style="padding: 100px 0; background: linear-gradient(180deg, rgba(0,168,132,0.03) 0%, var(--home-white) 100%); border-top: 1px solid rgba(0,168,132,0.05);">
        <div class="home-shell">
            ...
            <div style="display: flex; flex-direction: column; gap: 40px;">
                <?php $__empty_1 = true; $__currentLoopData = $promocionesHome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <article class="premium-promo-card fade-up">
                    ...
                    <div class="premium-promo-image-wrapper">
                        <img src="<?php echo e($promo->image); ?>" alt="<?php echo e($promo->title); ?>" loading="lazy">
                        <?php if($promo->discount_label): ?>
                    ...
                    <div class="premium-promo-content">
                        ...
                        <h3 class="premium-promo-title"><?php echo e($promo->title); ?></h3>
                        <p class="premium-promo-desc"><?php echo e($promo->description_short); ?></p>
                        ...
                        <div class="premium-promo-meta">
                            ...
                            <span><?php echo e($promo->status_class === 'status-expirada' ? 'Finalizó el' : 'Disponible hasta el'); ?> <?php echo e($promo->ends_at); ?></span>
                        </div>
                        <?php endif; ?>

                        <div>
                            <?php if($promoIsVigente): ?>
                            <a href="<?php echo e($promo->whatsapp_url); ?>" target="_blank" class="premium-promo-btn">
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(route('public.promociones')); ?>" class="premium-promo-btn" style="background: var(--home-jade-100); color: var(--home-jade-800); box-shadow: none;">
                ...
                <div style="text-align: center; padding: 60px; background: rgba(0,168,132,0.05); border-radius: 24px;">
                    ...
                    <a href="<?php echo e(route('public.reservar-cita')); ?>" class="premium-promo-btn">
    ...
    <section class="home-section">
        <div class="home-shell">
            <div class="home-section-head">
                ...
                <a href="<?php echo e(route('public.testimonios')); ?>" class="home-link">
                    Leer testimonios <i data-lucide="arrow-right"></i>
                </a>
            </div>

            <div class="home-testimonials-grid">
                <?php $__empty_1 = true; $__currentLoopData = $testimoniosHome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="home-card home-quote fade-up">
                    <div>
                        ...
                        <blockquote>"<?php echo e($testimonio->testimonio); ?>"</blockquote>
                    </div>
                    <div class="home-quote-author"><?php echo e($testimonio->nombre_paciente); ?></div>
                </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <article class="home-card home-quote fade-up">
                    <div>
    ...
    <section class="home-cta">
        ...
        <div class="home-shell home-cta-box">
            ...
            <a href="<?php echo e($doctora->whatsapp_url); ?>" target="_blank" class="home-btn home-btn-primary">
    ...
    <div id="homeEntryPopup" class="home-entry-popup" role="dialog" aria-modal="true" aria-labelledby="homeEntryPopupTitle" aria-hidden="true">
        <div class="home-entry-popup-card" role="document">
            ...
            <div class="home-entry-popup-media">
                <?php if($homePopupImage): ?>
                <img src="<?php echo e($homePopupImage); ?>" alt="<?php echo e($popupPromo ? $popupPromo->title : 'Miradent atención dental'); ?>">
                <?php else: ?>
                ...
                <?php if($popupPromo && $popupPromo->discount_percentage > 0): ?>
                <div style="position: absolute; top: 24px; left: 24px; background: #e11d48; color: white; padding: 12px 18px; border-radius: 16px; font-weight: 900; box-shadow: 0 10px 25px rgba(225, 29, 72, 0.5); transform: rotate(-4deg); z-index: 10; display: flex; flex-direction: column; align-items: center; justify-content: center; line-height: 1; border: 3px solid white;">
                    <span style="font-size: 2.2rem; margin-bottom: 6px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);">-<?php echo e($popupPromo->discount_percentage); ?>%</span>
            ...
            <div class="home-entry-popup-body">
                ...
                <h2 id="homeEntryPopupTitle"><?php echo e($popupPromo->title); ?></h2>
                <p><?php echo e($popupPromo->description_short); ?></p>
                <?php if($popupPromo->ends_at): ?>
                <p class="home-entry-popup-note">Disponible hasta <?php echo e($popupPromo->ends_at); ?>.</p>
                <?php endif; ?>
                <div class="home-entry-popup-actions">
                    <a href="<?php echo e($popupPromo->whatsapp_url); ?>" target="_blank" class="home-btn home-btn-primary" data-home-popup-close>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" style="width: 20px; height: 20px;">
                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
                        </svg>
                ...
                <div class="home-entry-popup-actions">
                    <a href="<?php echo e(route('public.reservar-cita')); ?>" class="home-btn home-btn-primary" data-home-popup-close>
                        <i data-lucide="calendar-check"></i>
                        Reservar cita
                    </a>
                    <button type="button" class="home-btn home-btn-secondary" data-home-popup-close>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/welcome.blade.php ENDPATH**/ ?>