...
<div class="container-fluid p-0">
    ...
    <div class="row g-3 align-items-center justify-content-between mb-4">
        ...
        <div class="col-12 col-xl-8">
            <div class="d-flex flex-wrap gap-2">
                <a href="<?php echo e(route('servicios.index', ['search' => request('search')])); ?>" class="btn btn-sm pill-filter <?php echo e(!request('category') || request('category') === 'Todas' ? 'active' : ''); ?>">
                    Todas
                </a>
                <?php $__currentLoopData = ['Prevención', 'Ortodoncia', 'Endodoncia', 'Estética', 'Cirugía', 'Implantes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('servicios.index', ['category' => $cat, 'search' => request('search')])); ?>" class="btn btn-sm pill-filter <?php echo e(request('category') === $cat ? 'active' : ''); ?>">
                        <?php echo e($cat); ?>
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <form action="<?php echo e(route('servicios.index')); ?>" method="GET">
                ...
                <div class="input-group" style="flex-wrap: nowrap;">
                    ...
                    <input type="text" name="search" class="form-control bg-light border-start-0 ps-0" placeholder="Buscar tratamiento..." value="<?php echo e(request('search')); ?>" style="border-radius: 0; border-color: var(--border-color); height: 42px; font-size: 0.875rem; box-shadow: none;">
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('servicios.index', ['category' => request('category')])); ?>" class="btn btn-outline-secondary d-flex align-items-center justify-content-center border-start-0" style="border-color: var(--border-color); border-radius: 0; background-color: var(--bg-content)">
    ...
    <?php if($servicios->isEmpty()): ?>
        <div class="card border-0 shadow-sm p-5 text-center" style="border-radius: 16px; border: 1px solid var(--border-color) !important;">
            ...
            <div>
                <a href="<?php echo e(route('servicios.index')); ?>" class="btn btn-outline-secondary px-4 mt-2" style="border-radius: 10px;">Limpiar Filtros</a>
            </div>
        </div>
    <?php else: ?>
        <div class="row g-4">
            <?php $__currentLoopData = $servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12 col-md-6 col-lg-4 col-xxl-3" data-axios-removable>
                    <div class="card border-0 shadow-sm h-100 service-card position-relative <?php echo e(!$servicio->activo ? 'inactive-card' : ''); ?>" style="border-radius: 16px; border: 1px solid var(--border-color) !important; overflow: hidden; transition: all 0.2s;">
                        ...
                        <div class="service-img-container position-relative service-img-clickable"
                             ...
                             data-id="<?php echo e($servicio->id); ?>"
                             data-update-url="<?php echo e(route('servicios.update', $servicio->id)); ?>"
                             data-nombre="<?php echo e($servicio->nombre); ?>"
                             data-categoria="<?php echo e($servicio->categoria); ?>"
                             data-precio="<?php echo e(number_format($servicio->precio, 2)); ?>"
                             data-precio-raw="<?php echo e($servicio->precio); ?>"
                             data-duracion="<?php echo e($servicio->duracion_minutos); ?>"
                             data-descripcion="<?php echo e($servicio->descripcion); ?>"
                             data-descripcion-raw="<?php echo e($servicio->descripcion); ?>"
                             data-activo="<?php echo e($servicio->activo ? 'Activo' : 'Inactivo'); ?>"
                             data-activo-val="<?php echo e($servicio->activo); ?>"
                             data-created="<?php echo e($servicio->created_at ? $servicio->created_at->format('d/m/Y H:i') : ''); ?>"
                             data-updated="<?php echo e($servicio->updated_at ? $servicio->updated_at->format('d/m/Y H:i') : ''); ?>"
                             data-imagen="<?php echo e($servicio->imagen_path ? asset($servicio->imagen_path) : ''); ?>"
                             style="height: 160px; overflow: hidden; cursor: pointer; border-bottom: 1px solid var(--border-color);">
                            <?php if($servicio->imagen_path): ?>
                                <img src="<?php echo e(asset($servicio->imagen_path)); ?>" alt="<?php echo e($servicio->nombre); ?>" style="width: 100%; height: 100%; object-fit: cover;" loading="lazy">
                            <?php else: ?>
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                ...
                                ?>
                                <span class="badge text-uppercase fw-bold" style="<?php echo \Illuminate\Support\Arr::toCssStyles([
                                    'font-size: 0.65rem',
                            ...
                            <!-- Title & Description -->
                            <h5 class="fw-bold mb-2 text-slate-800" style="font-family: 'Outfit', sans-serif; line-height: 1.3;"><?php echo e($servicio->nombre); ?></h5>
                            <p class="text-muted flex-grow-1" style="font-size: 0.85rem; line-height: 1.5;"><?php echo e(Str::limit($servicio->descripcion, 100, '...')); ?></p>
                            ...
                            <div class="d-flex align-items-center justify-content-between pt-3 border-top mt-3" style="border-color: rgba(0,0,0,0.05) !important;">
                                <div class="d-flex align-items-center gap-1 text-slate-700" style="font-size: 0.85rem;">
                                    ...
                                    <span><?php echo e($servicio->duracion_minutos); ?> min</span>
                                </div>
                                <div>
                                    <span class="text-muted fw-medium" style="font-size: 0.8rem;">Precio:</span>
                                    <span class="fw-bold text-dark más-1" style="font-size: 1.1rem; font-family: 'Outfit', sans-serif;">S/. <?php echo e(number_format($servicio->precio, 2)); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer bg-light border-0 py-3 px-4 d-flex align-items-center justify-content-between border-top">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary d-flex align-items-center gap-1 px-3 edit-service-btn" 
                                ...
                                data-nombre="<?php echo e($servicio->nombre); ?>"
                                data-categoria="<?php echo e($servicio->categoria); ?>"
                                data-precio="<?php echo e($servicio->precio); ?>"
                                data-duracion="<?php echo e($servicio->duracion_minutos); ?>"
                                data-descripcion="<?php echo e($servicio->descripcion); ?>"
                                data-activo="<?php echo e($servicio->activo); ?>"
                                data-imagen="<?php echo e($servicio->imagen_path ? asset($servicio->imagen_path) : ''); ?>"
                            ...
                            <!-- Delete -->
                            <form action="<?php echo e(route('servicios.destroy', $servicio->id)); ?>" method="POST" data-axios-delete data-confirm="¿Está seguro de que desea eliminar este tratamiento? Las citas agendadas históricas seguirán vinculadas.">
                                <?php echo csrf_field(); ?>
        ...
        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-between gap-2 mt-5">
            <span class="text-muted" style="font-size: 0.85rem;">
                Mostrando <?php echo e($servicios->firstItem()); ?> al <?php echo e($servicios->lastItem()); ?> de <?php echo e($servicios->total()); ?> tratamientos
            </span>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            <div class="modal-header border-bottom px-4 py-3" style="background-color: var(--bg-content)">
             ...
             <form action="<?php echo e(route('servicios.store')); ?>" method="POST" enctype="multipart/form-data" data-axios-submit data-axios-reset="true" data-axios-refresh="true">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/servicios.blade.php ENDPATH**/ ?>