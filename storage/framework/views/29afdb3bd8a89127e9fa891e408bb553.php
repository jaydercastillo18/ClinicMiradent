...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Miradent'); ?> - Panel Administrativo</title>
...
<body>
    ...
    <aside class="sidebar">
        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="sidebar-brand">
            <img src="<?php echo e(asset('images/miradent_logo_vectorizado.svg')); ?>" alt="Miradent" style="height: 36px; width: auto; object-fit: contain; border-radius: 8px;">
        </a>
        ...
        <div class="sidebar-menu">
            ...
            <a href="<?php echo e(url('/admin/pacientes')); ?>" class="sidebar-link <?php echo e(request()->is('admin/pacientes*') ? 'active' : ''); ?>">
                <i data-lucide="users"></i>
                <span>Pacientes</span>
            </a>

            <a href="<?php echo e(url('/admin/citas')); ?>" class="sidebar-link <?php echo e(request()->is('admin/citas*') ? 'active' : ''); ?>">
                <i data-lucide="calendar"></i>
                <span>Citas</span>
            </a>

            <?php if(auth()->user()->role === 'doctora'): ?>
            <a href="<?php echo e(route('finanzas.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/finanzas*') || request()->is('admin/pagos*') || request()->is('admin/gastos*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('servicios.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/servicios*') ? 'active' : ''); ?>">
                <i data-lucide="heart-handshake"></i>
                <span>Servicios</span>
            </a>

            <a href="<?php echo e(route('promociones.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/promociones*') ? 'active' : ''); ?>">
                <i data-lucide="gift"></i>
                <span>Promociones</span>
            </a>

            <a href="<?php echo e(route('casos-exito.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('casos-exito.*') ? 'active' : ''); ?>">
                <i data-lucide="sparkles"></i>
                <span>Antes y Después</span>
            </a>

            <a href="<?php echo e(route('testimonios.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('testimonios.*') ? 'active' : ''); ?>">
                <i data-lucide="star"></i>
                <span>Testimonios</span>
            </a>

            <a href="<?php echo e(route('instalaciones.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('instalaciones.*') ? 'active' : ''); ?>">
                <i data-lucide="image"></i>
                <span>Instalaciones</span>
            </a>

            <?php if(auth()->user()->role === 'doctora'): ?>
            <a href="<?php echo e(route('reportes.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/reportes*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('usuarios.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/usuarios*') ? 'active' : ''); ?>">
                <i data-lucide="users"></i>
                <span>Usuarios</span>
            </a>
            <a href="<?php echo e(route('auditoria.index')); ?>" class="sidebar-link <?php echo e(request()->is('admin/auditoria*') ? 'active' : ''); ?>">
                <i data-lucide="shield"></i>
                <span>Auditoría</span>
            </a>
            <a href="<?php echo e(url('/admin/configuracion')); ?>" class="sidebar-link <?php echo e(request()->is('admin/configuracion*') ? 'active' : ''); ?>">
                <i data-lucide="settings"></i>
                <span>Configuración</span>
            </a>
            <a href="<?php echo e(route('payment-settings.edit')); ?>" class="sidebar-link <?php echo e(request()->is('admin/configuracion-pagos*') ? 'active' : ''); ?>">
            ...
            <div class="topbar-right">
                ...
                <script>
                    ...
                    function loadNotificaciones() {
                        ...
                        axios.get('<?php echo e(route("admin.notificaciones")); ?>')
                            .then(response => {
                            ...
                            .then(response => {
                                ...
                                if (total > 0) {
                                    ...
                                    if (toast && !sessionStorage.getItem('miradent_toast_dismissed')) {
                                        ...
                                        if (pagos.length > 0) {
                                            actionsHtml += `
                                                <a href="<?php echo e(route('finanzas.index')); ?>" class="btn btn-primary flex-grow-1 py-1 px-2" style="background-color: var(--primary); border-color: var(--primary); border-radius: 8px; font-size: 0.75rem; font-weight: 600;">
                                                    Ver Caja
                                                </a>
                                            `;
                                        }
                                        if (citas.length > 0) {
                                            actionsHtml += `
                                                <a href="<?php echo e(url('/admin/citas')); ?>" class="btn btn-outline-success flex-grow-1 py-1 px-2" style="border-radius: 8px; font-size: 0.75rem; font-weight: 600;">
                                                    Ver Citas
                                                </a>
                                            `;
                                        }
                ...
                <div class="dropdown">
                    <a href="#" class="user-profile dropdown-toggle" id="profileDropdown" data-ui-toggle="dropdown" aria-expanded="false">
                        <?php if(Auth::user()?->doctora): ?>
                        <img src="<?php echo e(Auth::user()->doctora->avatar_url); ?>" alt="Avatar Doctora" class="user-avatar">
                        <?php endif; ?>
                        <div class="user-info">
                            <span class="user-name"><?php echo e(Auth::user()?->name ?? ''); ?></span>
                            <span class="user-role"><?php echo e(Auth::check() && Auth::user()->role === 'doctora' ? 'Dentista / Propietaria' : 'Asistente'); ?></span>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg" aria-labelledby="profileDropdown" style="background-color: var(--bg-content)">
                        <?php if(auth()->check() && auth()->user()->role === 'doctora'): ?>
                        <li>
                            <a class="dropdown-item py-2 px-3 d-flex align-items-center gap-2" href="<?php echo e(url('/admin/doctora')); ?>">
                        ...
                        <?php if(auth()->user()->role === 'doctora'): ?>
                        <li>
                            <a class="dropdown-item py-2 px-3 d-flex align-items-center gap-2" href="<?php echo e(url('/admin/configuracion')); ?>">
    ...
    <div id="miradent-reminder-toast" class="miradent-alert-toast p-0">
        ...
        <div class="p-3 overflow-auto" style="max-height: 40vh;">
            <p class="text-slate-700 mb-2" style="font-size: 0.8rem; font-weight: 500;">
                <?php echo e(Auth::user()->name); ?>, tiene actividades pendientes:
            </p>
...
<?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/layouts/plantilla.blade.php ENDPATH**/ ?>