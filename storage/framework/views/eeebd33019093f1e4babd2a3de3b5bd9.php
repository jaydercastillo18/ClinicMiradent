<?php $__env->startSection('title', 'Promociones | Miradent'); ?>
...
<section class="promos-grid-container">
    <div class="container-premium">
        ...
        <div class="promos-grid">
            ...
            <div class="promo-card fade-up" <?php echo 'style="animation-delay: ' . ($loop->index * 0.1) . 's;"'; ?>>
                <?php if($promo->image): ?>
                <div class="promo-img-wrap">
                    <img src="<?php echo e($promo->image); ?>" alt="<?php echo e($promo->title); ?>" loading="lazy">
                    <span class="promo-status-badge" style="background: rgba(255,255,255,0.92); color: var(--jade-800);"><?php echo e($promo->status_label); ?></span>
                    <?php if($promo->discount_label): ?>
                    <span class="promo-discount-badge" style="<?php echo \Illuminate\Support\Arr::toCssStyles([$promo->discount_style ?? '']) ?>"><?php echo e($promo->discount_label); ?></span>
                    <?php endif; ?>
                </div>
                <?php endif; ?>

                <div class="promo-card-body">
                    <h4><?php echo e($promo->title); ?></h4>
                    ...
                    <div class="promo-card-footer">
                        <div class="promo-date-col">
                            ...
                            <span class="promo-date-value">
                                <i data-lucide="calendar-clock" style="width:16px;height:16px;"></i> <?php echo e($promo->ends_at); ?>

                            </span>
                        </div>
                        <a href="<?php echo e($promo->whatsapp_url); ?>" target="_blank" class="btn-Reservar ahora ya!!">
        ...
        <div class="empty-state-card text-center fade-up">
            ...
            <a href="<?php echo e(url('/')); ?>" style="display: inline-flex; align-items: center; gap: 8px; background: var(--jade-600); color: #fff; padding: 16px 32px; border-radius: 999px; font-weight: 800; text-decoration: none; box-shadow: 0 10px 20px rgba(0,168,132,0.3);">
                Volver al inicio
            </a>
        </div>
        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/public_promociones.blade.php ENDPATH**/ ?>