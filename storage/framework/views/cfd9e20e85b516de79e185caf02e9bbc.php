...
<?php $esModal = request()->has('modal') || request()->ajax(); ?>
<div class="<?php echo e(request()->ajax() ? '' : 'container-fluid p-0'); ?>">
    <!-- Header -->
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4 pb-3" style="border-bottom: 2px solid #e2e8f0;">
        ...
        <div>
            ...
            <?php else: ?>
            <a href="<?php echo e(route('pacientes.index')); ?>" class="btn btn-light border d-flex align-items-center gap-2" style="font-weight: 500; padding: 8px 16px; border-radius: 10px; font-size: 0.9rem;">
    ...
    <form action="<?php echo e(route('pacientes.store')); ?>" method="POST" data-axios-submit data-axios-no-reload="true" data-axios-close-modal="true" id="form-regpaciente">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nombre')); ?>" placeholder="Ej. Alejandro" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('apellido')); ?>" placeholder="Ej. Mendoza" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dni')); ?>" placeholder="Ej. 74859632" required style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                <?php $__errorArgs = ['dni'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('telefono')); ?>" placeholder="Ej. 987654321" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" placeholder="Ej. paciente@ejemplo.com" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha_nacimiento')); ?>" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
                                    ...
                                    <option value="<?php echo e($blood); ?>" <?php echo e(old('tipo_sangre') == $blood ? 'selected' : ''); ?>><?php echo e($blood); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Ej. Calle Los Pinos 145, Dpto 302, San Borja" style="border-radius: 8px; border-color: var(--border-color);"><?php echo e(old('direccion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Ej. Hipertensión bajo medicación, diabetes controlada, asma, etc." style="border-radius: 8px; border-color: var(--border-color);"><?php echo e(old('antecedentes_medicos')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Ej. Alergia a la penicilina, analgésicos, látex, etc. (Escribe 'Ninguna' si no tiene)" style="border-radius: 8px; border-color: var(--border-color);"><?php echo e(old('alergias')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Ej. Tomo aspirina diaria, insulina, anticoagulantes, etc." style="border-radius: 8px; border-color: var(--border-color);"><?php echo e(old('medicamentos_habituales')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contacto_emergencia_nombre')); ?>" placeholder="Ej. María Mendoza" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contacto_emergencia_telefono')); ?>" placeholder="Ej. 912345678" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contacto_emergencia_parentesco')); ?>" placeholder="Ej. Madre, Esposo(a), Hermano" style="border-radius: 8px; height: 42px; border-color: var(--border-color);">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 16px; border: 1px solid var(--border-color) !important; background-color: #fafbfc;">
                    <div class="card-body p-4 d-flex flex-column gap-3">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('pacientes.index')); ?>" class="btn btn-outline-secondary w-100 py-3" style="border-radius: 10px; font-weight: 500; font-size: 0.95rem;">
                            Cancelar y volver
                        </a>
                        <?php endif; ?>
                    </div>
...
<script id="existing-patients-data" type="application/json">
    <?php echo json_encode($existingPatients ?? [], 15, 512) ?>
</script>
<script>
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/regpaciente.blade.php ENDPATH**/ ?>