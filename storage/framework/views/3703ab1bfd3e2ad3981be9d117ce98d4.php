<?php $__env->startSection('title', 'Contacto | Miradent'); ?>
            ...
            <div class="doctora-flex">
                ...
                <div>
                    <div class="profile-image-container fade-up">
                        <img src="<?php echo e($doctora->avatar); ?>" alt="<?php echo e($doctora->name); ?>" class="profile-image">
                    </div>
                </div>
                ...
                <div class="doctora-info fade-up" style="animation-delay: 0.1s;">
                    ...
                    <div style="margin-bottom: 12px;">
                        <span class="badge-jade" style="background: var(--jade-100); color: var(--jade-800); padding: 6px 14px; font-size: 0.75rem;"><?php echo e($doctora->specialty); ?></span>
                    </div>
                    <?php endif; ?>

                    <h2><?php echo e($doctora->name); ?></h2>

                    <?php if($doctora->bio): ?>
                    <p><?php echo e($doctora->bio); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="badge-cop">
                        ...
                        <div>
                            ...
                            <div style="font-weight:800; color:var(--jade-950); font-size:0.9rem;">Colegio Odontológico del Perú — COP <?php echo e($doctora->cop ?: '50039'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-premium">
        <div class="clinica-grid">
            ...
            <div class="clinica-info-col fade-up">
                ...
                <div class="clinica-cards">
                    ...
                    <div class="info-card">
                        ...
                        <div>
                            ...
                            <div class="info-card-content-value"><a href="<?php echo e($doctora->phone_url); ?>"><?php echo e($doctora->phone); ?></a></div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="info-card">
                        ...
                        <div style="width:100%;">
                            ...
                            <div style="width:100%;">
                                <?php if(is_iterable($horarios) && count($horarios) > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $horarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e(is_array($h) ? ($h['day'] ?? '') : ($h->day ?? '')); ?></td>
                                            <td><span style="background:var(--jade-50); padding:2px 8px; border-radius:6px;"><?php echo e(is_array($h) ? ($h['start'] ?? '') : ($h->start ?? '')); ?> - <?php echo e(is_array($h) ? ($h['end'] ?? '') : ($h->end ?? '')); ?></span></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </table>
                                <?php else: ?>
                                    <div class="info-card-content-value" style="font-weight:700; font-size:0.9rem;"><?php echo e($doctora->horario ?: 'Previa cita programada'); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <a href="<?php echo e($doctora->whatsapp_url); ?>" target="_blank" class="btn-whatsapp">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kalil\Desktop\miradent\resources\views/public_contacto.blade.php ENDPATH**/ ?>